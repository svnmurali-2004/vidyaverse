        ...
        <Card className="bg-blue-50/50 border-blue-200">
          <CardHeader>
            ...
            <CardDescription className="text-blue-700">
              Understanding how your descriptions will be displayed
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <h4 className="font-medium text-blue-900">Short Description</h4>
                <p className="text-sm text-blue-700">
                  • Used in course cards and listings
                </p>
                <p className="text-sm text-blue-700">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-blue-700">
                  • Supports rich formatting (headings, lists, etc.)
                </p>
                <p className="text-sm text-blue-700">
                  • Used for SEO and detailed course information
                </p>
              </div>
            </div>
          </CardContent>
