  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(error.error || error.message || 'Failed to update quiz');
      }
    } catch (error) {
      console.error('Error updating quiz:', error);
      toast.error('Network error: Failed to update quiz');
    } finally {
      setLoading(false);
    }
  };
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="isActive">Active (students can take this quiz)</Label>
            </div>
          </CardContent>
        </Card>
