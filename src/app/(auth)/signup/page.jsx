            ...
            <form onSubmit={handleSignUp}>
              <div className="grid gap-6">
                ...
                <div className="text-center text-sm text-muted-foreground">
                  ...
                  <Link href="/signin" className="underline underline-offset-4 text-primary hover:text-primary/80">
                    Sign in
                  </Link>
                </div>
              </div>
        ...
        <div className="flex h-full items-center justify-center p-6 relative z-10">
          <div className="text-center max-w-lg">
            ...
            <p className="mx-auto text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Connect with millions of learners and instructors from around the world.
            </p>
          </div>
        </div>
      </div>
